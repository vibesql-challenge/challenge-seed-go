...
- Use `interface{}` or generics for SQL values
- `map[string][]Row` works well for tables
- Consider using a parser generator or hand-roll recursive descent
- Go's `sort` package is great for ORDER BY
- Channels can help with query execution pipelines
